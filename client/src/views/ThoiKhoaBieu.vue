<template>
  <div class="">
    <h1 class="text-3xl font-bold mb-10">Danh Sach Thời Khóa Biểu</h1>
    ...
    <div class="">
      <div class="bg-white p-4 ">
        ...
        <el-table :data="listClass" border caption="Table Title"
        ...
        <el-dialog v-model="editVisible" title='Sửa thời khóa biểu lớp' width="80%">
          ...
          <table class="min-w-full w-[1000px]  table-auto border-collapse block md:table">
            ...
            <tr class="border border-green-300  block md:table-row absolute -top-full md:top-auto -left-full md:left-auto md:relative">
              <th class="bg-green-500 p-2 text-white font-bold md:border md:border-grey-500 text-center block md:table-cell">
                Tiết
              </th>
              <th class="bg-green-500 p-2 text-white font-bold md:border md:border-grey-500 text-center block md:table-cell">
                Thứ 2
            ...
            <tbody>
            <tr v-for="i in 10">
              <td class=" text-center   border-r border-r-green-300 font-medium text-base py-2 px-2  border-b border-l border-b-green-300">
                {{ i }}
              </td>
              <td v-for="dayItem in dataDay"
                ...
                <template v-if="this.dataEdit.find(lesson => lesson.time == i && lesson.nameDate === dayItem)">
                  <div>
                    <select
