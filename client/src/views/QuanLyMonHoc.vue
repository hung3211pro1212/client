  ...
  <div class="">
    ...
    <div class="">
      <div class="bg-white p-4 ">
        ...
        <el-table :data="this.listSubject" border caption="Table Title"
...
export default {
  ...
  methods: {
    ...
    submitEdit(){
      SubjectService.updateData( { name:this.formEdit.name,Khoi:this.formEdit.Khoi},this.formEdit.id ).then(result=>{
