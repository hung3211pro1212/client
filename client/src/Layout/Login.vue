...
<template>
  ...
  <head>
    ...
    <link rel="canonical" href="https://www.creative-tim.com/product/soft-ui-dashboard-pro-tailwind" />
    <meta name="keywords"
      content="creative tim, html dashboard, html css dashboard, web dashboard, tailwind dashboard, tailwind, tailwindcss, tailwind css, css3 dashboard, tailwind admin, Soft UI Dashboard Pro Tailwind, frontend, responsive tailwind dashboard, dashboard, premium dashboard, admin dashboard, premium admin dashboard, tailwind admin dashboard, premium tailwind admin dashboard">
    <meta name="description"
      content="Download Soft UI Tailwind CSS, a Premium Tailwind CSS Admin Template developed by Creative Tim. Over 70 components, see the live demo on our site and join over 1,800,000 creatives!">
    <meta name="twitter:card" content="product">
    <meta name="twitter:site" content="@creativetim">
    <meta name="twitter:title" content="Soft UI Tailwind CSS: Premium Tailwind CSS Admin Template">
    <meta name="twitter:description"
      content="Download Soft UI Tailwind CSS, a Premium Tailwind CSS Admin Template developed by Creative Tim. Over 70 components, see the live demo on our site and join over 1,800,000 creatives!">
    <meta name="twitter:creator" content="@creativetim">
    <meta name="twitter:image"
      content="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-dashboard/soft-ui-dashboard-pro-tailwind.jpg">
    <meta property="fb:app_id" content="655968634437471">
    <meta property="og:title" content="Soft UI Tailwind CSS: Premium Tailwind CSS Admin Template">
    <meta property="og:description"
      content="Download Soft UI Tailwind CSS, a Premium Tailwind CSS Admin Template developed by Creative Tim. Over 70 components, see the live demo on our site and join over 1,800,000 creatives!">
    <meta property="og:type" content="article" />
    <meta property="og:url"
      content="http://demos.creative-tim.com/soft-ui-dashboard-pro-tailwind/pages/dashboards/default.html" />
    ...
    <link href="../../../assets/css/soft-ui-dashboard-tailwind.min.css?v=1.0.1" rel="stylesheet" />
          ...
          <nav
            ...
            <div class="container flex flex-wrap items-center justify-between lg-max:overflow-hidden lg:flex-nowrap">
              <a class="py-2.5 text-sm mr-4 ml-4 whitespace-nowrap font-bold text-slate-700 lg:ml-0"
                href="../../../pages/dashboards/default.html">Soft UI Dashboard PRO</a>
              ...
              <div
                ...
                <ul class="flex flex-col pl-0 mx-auto mb-0 list-none md-max:w-full lg:flex-row">
                  <li
                    ...
                    <a aria-expanded="false" nav-dropdown-trigger="pages" role="button"
                    ...
                    <div nav-dropdown="pages"
                        ...
                        <div class="w-full max-w-full px-6 py-2 flex-0">
                          <div class="flex flex-wrap -mx-3">
                            <div class="relative w-4/12 max-w-full px-3 flex-0">
                              <div
                                class="flex items-center px-0 py-2 mb-0 font-bold text-sm whitespace-nowrap text-slate-700 ">
                                <div class="inline-block">
                                  <div
                                    class="flex items-center justify-center w-6 h-6 mr-2 text-center text-black bg-center rounded-lg fill-current stroke-none bg-gradient-to-tl from-purple-700 to-pink-500">
                              ...
                              <a href="../../../pages/dashboards/vr/vr-default.html"
                                class="hover:text-slate-700 hover:bg-gray-200 block w-full px-4 py-1.2 clear-both font-normal text-slate-500 text-align-inherit whitespace-nowrap bg-transparent border-0 lg:transition-colors lg:duration-300 lg:ease-soft rounded-lg">
                              ...
                              <hr
                                class="absolute top-0 right-0 w-px h-full bg-transparent bg-gradient-to-b from-transparent via-black/40 to-transparent">
                            </div>
                            <div class="relative w-4/12 max-w-full px-3 flex-0">
                              <div
                                class="flex items-center px-0 py-2 mb-0 font-bold text-sm whitespace-nowrap text-slate-700 ">
                      ...
                      <div class="lg:hidden lg-max:overflow-x-hidden">
                        <div class="flex items-center py-2 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">
                          <div class="inline-block">
                            <div
                              class="flex items-center justify-center w-6 h-6 mr-2 text-center text-black bg-center rounded-lg fill-current bg-gradient-to-tl from-purple-700 to-pink-500 stroke-none">
                              <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>shop </title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  ...
                  <li
                    ...
                    <a aria-expanded="false" nav-dropdown-trigger="authentication" role="button"
                      class="flex items-center justify-between px-4 py-2 pl-2 font-normal transition-all cursor-pointer select-none text-slate-700 lg-max:text-slate-700 ease-soft-in-out lg:px-2 text-sm">
                      Authentication
                      <img src="../../../assets/img/down-arrow-dark.svg" alt="down-arrow" class="hidden ml-1 lg:block">
                      <img src="../../../assets/img/down-arrow-dark.svg" alt="down-arrow" class="block ml-1 lg:hidden">
                      ...
                      <div class="flex-wrap hidden -mx-3 lg:flex">
                        ...
                        <div class="flex flex-col justify-center w-6/12 max-w-full px-3 pl-0 flex-0">
                          <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            ...
                            <li nav-nested-menu-trigger
                              class="after:absolute after:content-[''] after:h-full after:left-full after:w-1/2 after:bottom-0 relative block p-0 bg-white border-0 rounded-b-lg">
                              <a
                                class="select-none hover:text-slate-700 hover:bg-gray-200 flex w-full px-4 py-1.2 clear-both font-normal text-slate-500 text-align-inherit bg-transparent border-0 justify-between items-center mb-1 pl-4 rounded-lg lg:transition-colors lg:duration-300 lg:ease-soft">
                                <span>Error</span>
                                <img src="../../../assets/img/down-arrow.svg" alt="down-arrow" class="lg:-rotate-90">
                      ...
                      <div class="hidden lg:flex">
                        <ul class="flex flex-col w-full pl-0 mb-0 list-none">
                          <li class="relative block p-0 bg-white border-0 rounded-t-lg">
                            <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-gray-200 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                              href="../../../pages/applications/kanban.html">
                              <div class="flex">
                                <div class="flex mt-1 mr-4 text-black fill-current h-4 w-4 stroke-none">
                                  <i
                                    class="relative text-transparent ni leading-none ni-single-copy-04 bg-gradient-to-tl from-purple-700 to-pink-500 bg-clip-text z-1"></i>
                                </div>
                          ...
                          <li class="relative block p-0 bg-white border-0">
                            <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-gray-200 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                              ...
                              <div class="flex">
                                <div class="flex mt-1 mr-4 text-black fill-current h-4 w-4 stroke-none">
                                  <i
                                    class="relative text-transparent ni leading-none ni-laptop bg-gradient-to-tl from-purple-700 to-pink-500 bg-clip-text z-1"></i>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                  <div>
                          ...
                          <li class="relative block p-0 bg-white border-0">
                            <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-gray-200 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                              ...
                              <div class="flex">
                                <div class="flex mt-1 mr-4 text-black fill-current h-4 w-4 stroke-none">
                                  <i
                                    class="relative text-transparent ni leading-none ni-badge bg-gradient-to-tl from-purple-700 to-pink-500 bg-clip-text z-1"></i>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                  <div>
                          ...
                          <li class="relative block p-0 bg-white border-0 rounded-b-lg">
                            <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-gray-200 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                              ...
                              <div class="flex">
                                <div class="flex mt-1 mr-4 text-black fill-current h-4 w-4 stroke-none">
                                  <i
                                    class="relative text-transparent ni leading-none ni-notification-70 bg-gradient-to-tl from-purple-700 to-pink-500 bg-clip-text z-1"></i>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                  <div>
                  ...
                  <li
                    class="relative mx-2 md-max:static group lg:after:content-[''] lg:after:top-0 lg:hover:after:top-full lg:after:absolute lg:after:left-0 lg:after:-bottom-6 lg:after:w-full lg:after:h-full">
                    <a aria-expanded="false" nav-dropdown-trigger="ecommerce" role="button"
                      class="flex items-center justify-between px-4 py-2 pl-2 font-normal transition-all cursor-pointer select-none text-slate-700 lg-max:text-slate-700 ease-soft-in-out lg:px-2 text-sm">
                      Ecommerce
                      <img src="../../../assets/img/down-arrow-dark.svg" alt="down-arrow" class="hidden ml-1 lg:block">
                      <img src="../../../assets/img/down-arrow-dark.svg" alt="down-arrow" class="block ml-1 lg:hidden">
                    </a>
                    <div nav-dropdown="ecommerce"
                      class=" lg:group-hover:pointer-events-auto lg:group-hover:transform-dropdown-show lg:group-hover:opacity-100 lg:group-hover:before:-top-4.8  sm-max:right-auto md-max:left-0 md-max:right-0 lg-max:bg-transparent lg-max:overflow-scroll lg-max:overflow-x-hidden lg-max:relative lg-max:shadow-none lg-max:transform-none lg-max:block lg-max:h-0 lg-max:transition-all lg-max:duration-350 lg-max:ease-soft lg-max:pt-0 lg-max:pb-0 lg-max:opacity-0 lg-max:top-0 lg-max:origin-top lg-max:pointer-events-none static p-4 m-0 mt-0 text-left list-none bg-white rounded-2xl lg:mt-4 lg:min-w-92 lg:absolute z-100 text-sm text-slate-500 bg-clip-padding lg:shadow-soft-3xl lg:cursor-pointer lg:transition-all lg:duration-250 lg:block lg:opacity-0 lg:top-0 lg:origin-top lg:pointer-events-none lg:transform-dropdown lg:before:font-awesome lg:before:content-['\f0d8'] lg:before:absolute lg:before:top-0 lg:before:left-7 lg:before:right-auto lg:before:text-5.5 lg:before:text-white lg:before:transition-all lg:before:duration-350 lg:before:ease-soft">
                      <div class="flex-wrap hidden -mx-3 lg:flex">
                        <div class="w-full max-w-full px-6 py-2 flex-0">
                          <div class="flex flex-wrap -mx-3">
                  ...
                  <li
                    ...
                    <div nav-dropdown="docs"
                      class=" lg:group-hover:pointer-events-auto lg:group-hover:transform-dropdown-show lg:group-hover:opacity-100 lg:group-hover:before:-top-4.8  sm-max:right-auto md-max:left-0 md-max:right-0 lg-max:bg-transparent lg-max:overflow-scroll lg-max:overflow-x-hidden lg-max:relative lg-max:shadow-none lg-max:transform-none lg-max:block lg-max:h-0 lg-max:transition-all lg-max:duration-350 lg-max:ease-soft lg-max:pt-0 lg-max:pb-0 lg-max:opacity-0 lg-max:top-0 lg-max:origin-top lg-max:pointer-events-none static p-4 m-0 mt-0 text-left list-none bg-white rounded-2xl lg:mt-4 lg:min-w-92 lg:absolute z-100 text-sm text-slate-500 bg-clip-padding lg:shadow-soft-3xl lg:cursor-pointer lg:transition-all lg:duration-250 lg:block lg:opacity-0 lg:top-0 lg:origin-top lg:pointer-events-none lg:transform-dropdown lg:before:font-awesome lg:before:content-['\f0d8'] lg:before:absolute lg:before:top-0 lg:before:left-7 lg:before:right-auto lg:before:text-5.5 lg:before:text-white lg:before:transition-all lg:before:duration-350 lg:before:ease-soft">
                      <div class="hidden lg:block">
                        <ul class="flex flex-col pl-0 mx-auto mb-0 list-none">
                          <li class="relative block p-0 bg-white border-0 rounded-t-lg">
                            <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg hover:text-slate-700 hover:bg-gray-200 text-slate-500 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                            href="https://www.creative-tim.com/learning-lab/tailwind/html/what-is-tailwind-css/soft-ui-dashboard/">
                            <div class="flex">
                              <div class="flex mt-1 mr-4 text-black fill-current h-4 w-4 stroke-none">
                                <svg class="text-slate-400" width="16px" height="16px" viewBox="0 0 40 40" version="1.1"
                                  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                  <title>spaceship</title>
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1720.000000, -592.000000)" fill="#FFFFFF"
                              ...
                              <div>
                                <h6 class="flex p-0 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">Getting
                                  Started</h6>
                                <span class="leading-normal text-sm">All about overview, quick start, license and
                                  contents</span>
                              </div>
                            </div>
                          </a>
                        ...
                        <li class="relative block p-0 bg-white border-0">
                          <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg hover:text-slate-700 hover:bg-gray-200 text-slate-500 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                            ...
                            <div class="flex">
                              <div class="flex mt-1 mr-4 text-black fill-current h-4 w-4 stroke-none">
                                <svg class="text-slate-400" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
                                  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                  <title>document</title>
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1870.000000, -591.000000)" fill="#FFFFFF"
                              ...
                              <div>
                                <h6 class="flex p-0 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">Foundation
                                </h6>
                        ...
                        <li class="relative block p-0 bg-white border-0">
                          <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg hover:text-slate-700 hover:bg-gray-200 text-slate-500 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                            ...
                            <div class="flex">
                              <div class="flex mt-1 mr-4 text-black fill-current h-4 w-4 stroke-none">
                                <svg class="text-slate-400" width="16px" height="16px" viewBox="0 0 42 42" version="1.1"
                                  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                  <title>box-3d-50</title>
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF"
                              ...
                              <div>
                                <h6 class="flex p-0 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">Components
                                </h6>
                                <span class="leading-normal text-sm">Explore our collection of fully designed
                                  components</span>
                              </div>
                            </div>
                          </a>
                        ...
                        <li class="relative block p-0 bg-white border-0">
                          <a class="block clear-both w-full px-4 py-2 font-normal bg-transparent border-0 rounded-lg hover:text-slate-700 hover:bg-gray-200 text-slate-500 text-align-inherit whitespace-nowrap lg:transition-colors lg:duration-300 lg:ease-soft"
                            href="https://www.creative-tim.com/learning-lab/tailwind/html/charts/soft-ui-dashboard/">
                            <div class="flex">
                              <div class="flex mt-1 mr-4 text-black fill-current h-4 w-4 stroke-none">
                                <svg class="text-slate-400" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
                                  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                              ...
                              <div>
                                <h6 class="flex p-0 mb-0 font-bold text-sm whitespace-nowrap text-slate-700">Plugins
                                </h6>
              ...
              <ul class="hidden pl-0 mb-0 list-none lg:block lg:flex-row">
                <li>
                  <a href="https://www.creative-tim.com/product/soft-ui-dashboard-pro-tailwind" target="_blank"
                    class="inline-block px-8 py-2 mb-0 mr-1 font-bold text-center text-white uppercase align-middle transition-all border-0 cursor-pointer ease-soft-in-out text-xs leading-pro bg-gradient-to-tl from-purple-700 to-pink-500 tracking-tight-soft shadow-soft-md bg-150 bg-x-25 rounded-7 hover:scale-102 active:opacity-85">Buy
                    Now</a>
                </li>
              </ul>
            </div>
              ...
              <div
                ...
                <div class="border-black/12.5 rounded-b-2xl border-t-0 border-solid p-6 text-center pt-0 px-1 sm:px-6">
                  <p class="mx-auto mb-4">Don't have an account? <a
                      href="../../../pages/authentication/signup/basic.html"
                      class="font-bold text-transparent bg-clip-text bg-gradient-to-tl from-blue-600 to-cyan-400">Sign
                      up</a></p>
                </div>
              </div>
            </div>
